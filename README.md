...
# BSC/EVM Frontrunning Bot Alpha

This experimental frontrunning bot targets all major EVM networks. BSC, ETH, AVAX, AVAX, FTM, CRO, Harmony, Milkomeda, etc. Automatically scans the mempool for profitable pending transactions and can inject your wallet address for maximum gains. Alpha release. Use at your own risk. For educational uses only.
...
A: I managed to turn 0.2 BNB into 2 BNB in 1 day, however your results maybe different. You may make more than when I first tested this tool.
